...
public class Console {
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    if (userDTO != null) {
                        ...
                        while (userLogged) {
                            userMenu();
                            int option = scannerUser.nextInt();
                            switch (option) {
                                case 0:
                                    userLogged = false;
                                    break;
                                case 1:
                                    ...
                                    try {
                                        productQuantity = scannerUser.nextInt();
                                ...
                                case 5:
                                    ...
                                    String confirm = scannerUser.next();
                                ...
                                case 7:
                                    ...
                                    products.stream().filter((product) -> product.quantity() > 0).forEach((product) -> System.out.println("Product name: " + product.name() + " , Price: " + product.price() + " , Available Quantity: " + product.quantity()));
                                    break;
                                case 8:
                                    loggedUser.shoppingCart().emptyCart();
                ...
                case 3:
                    ...
                    if (userDTO != null) {
                        ...
                        while (adminLogged) {
                            adminMenu();
                            int option = adminScanner.nextInt();
                            switch (option) {
                                case 0:
                                    adminLogged = false;
                                    break;
                                ...
                                case 5:
                                    ...
                                    List<ProductDTO> products = this.service.getServiceProduct().findAll();
                                    products.forEach((product) -> System.out.println("Product name: " + product.name() + " , Price: " + product.price() + " , Available Quantity: " + product.quantity()));
                                    break;
                                case 6:
    ...
    private void printOrders(List<OrderDTO> orders) {
        orders.forEach((order) -> {
            ...
            orderProducts.forEach((product) -> System.out.println("Product name: " + product.name() + " , Price: " + product.price() + " , Quantity: " + product.quantity()));
            System.out.println();
        });
    }
